...
class AppTheme {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // CARE TYPE COLORS (used by care task UI)
  // ══════════════════════════════════════════════════════════════════════════

  static const Color waterBlue = Color(0xFF1976D2);
  static const Color fertilizerOrange = Color(0xFFE65100);
  static const Color mistCyan = Color(0xFF00ACC1);
  static const Color inspectPurple = Color(0xFF7B1FA2);
  static const Color repotBrown = Color(0xFF6D4C41);
  static const Color pruneRed = Color(0xFFC62828);
